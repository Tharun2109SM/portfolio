      ...
      <div className="max-w-[90rem] mx-auto w-full px-6 md:px-12">
        ...
        <div className="w-full border-t border-[#0d0d0d]/10 pt-16 flex flex-col">
          ...
          <p className="font-subscript text-[#888888] uppercase tracking-widest text-xs mb-8 flex items-center justify-center lg:justify-start gap-4">
            ...
            Swipe horizontally to explore device stack
            <span className="w-12 h-px bg-[#0d0d0d]/20"></span>
          </p>
        </div>
      </div>

      <div className="relative w-full text-[#0d0d0d] flex items-center overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-32">
        <div className="flex flex-nowrap min-w-full">
            
          {/* === MACBOOK SECTION === */}
          <div className="w-screen flex-[0_0_100%] snap-center flex justify-center items-center px-6 md:px-12 min-h-[50vh] md:min-h-[60vh] py-8">
          ...
          <div className="w-screen flex-[0_0_100%] snap-center flex justify-center items-center px-6 md:px-12 min-h-[50vh] md:min-h-[60vh] py-8">
            <motion.div layout className={`w-full max-w-[85rem] flex flex-col lg:flex-row items-center gap-12 lg:gap-20 transition-all duration-700 ${isIphoneOpen ? 'lg:justify-between' : 'lg:justify-center'}`}>
              ...
              <motion.div
                layout
                className={`relative cursor-pointer group z-40 flex-shrink-0 transition-all duration-700 ease-[cubic-bezier(0.25,0.1,0.1,1.0)] ${isIphoneOpen ? 'w-[14rem] h-[20rem] lg:w-[18rem] lg:h-[26rem]' : 'w-[18rem] h-[26rem] lg:w-[26rem] lg:h-[38rem]'}`}
                style={{ perspective: "1500px" }}
