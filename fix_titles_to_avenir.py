...
# Make the device titles pure Avenir, bold, matching the rest of the spec panel purely.
gig_content = gig_content.replace(
    ...
    'className="text-2xl md:text-4xl font-[\'Avenir\',_sans-serif] font-bold text-[#0d0d0d] mb-6 border-b border-[#0d0d0d]/10 pb-4 tracking-tighter uppercase"'
)
